...
public class FriendBean {
    ...
    public FriendBean(int id, String usercode, String username, String pwd, String sex, String birthday, String headerimg, String nick, int utype, String imuseraccount, String signdesc, int openlocation, int openmsgalert) {
        this.id = id;
